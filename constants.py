...
EXERCISE_METADATA = {
    ...
    "Leg Press": {"category": "Quads", "pattern": "Squat Pattern", "movement_type": "Compound", "equipment": "Machine", "plate_loaded": True, "bar_weight": 0},
    ...
    "Reverse Hyper": {"category": "Glutes", "pattern": "Glute Isolation", "movement_type": "Isolation", "equipment": "Machine", "plate_loaded": True, "bar_weight": 0},
